...
const Button = sdkClass({
  initialize(chromeWindow, callback) {
    ...
    this.button.icon.id = 'security-advisor-button-icon';
    this.button.icon.setAttribute('src', sdkData.url('recommendation/warningWhite.svg'));
...
getNodeView.define(Button, button => button.button.icon);
